...
import io.github.oni0nfr1.dynamicrider.client.hud.elements.timer.SpectateHudTimerBuilder
import io.github.oni0nfr1.skid.client.api.engine.NitroEngine
import io.github.oni0nfr1.skid.client.api.kart.KartRef

fun defaultSpectateSceneDefinition() =
hudSceneDefinition<NitroEngine> {
    ...
    element<SpectateHudTimerBuilder> {
        layout {
...
fun defaultSpectateScene(kart: KartRef.Specific<NitroEngine>) =
    defaultSpectateSceneDefinition().create(kart)
