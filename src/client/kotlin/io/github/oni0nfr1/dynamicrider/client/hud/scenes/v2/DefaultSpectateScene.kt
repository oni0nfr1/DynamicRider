...
import io.github.oni0nfr1.dynamicrider.client.hud.elements.v2.timer.SpectateHudTimerBuilder
import io.github.oni0nfr1.dynamicrider.client.hud.elements.v2.timer.SpectateHudTimerSpec

fun defaultSpectateScene() = hudScene {
    ...
    element<SpectateHudTimerBuilder, SpectateHudTimerSpec> {
        layout {
