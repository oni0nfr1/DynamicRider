...
object PreviewStateFieldEditor {
    fun fields(context: PreviewHudSceneContext<*>): List<PreviewStateField> = buildList {
        ...
        if (state is PreviewV1KartState) {
    ...
    fun update(
        ...
        when (fieldId) {
            ...
            DRIFTING -> (state as PreviewNitroKartState).isDrifting = primitive!!.boolean
            ...
            EXCEED_GAUGE -> (state as PreviewV1KartState).exceedGauge = primitive!!.float
